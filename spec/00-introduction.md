...
- A **client / caller** writing against aala can rely on every MUST clause being true in any conformant implementation and can defensively reason about SHOULD / MAY by consulting `Orchestration.capabilities()`.
